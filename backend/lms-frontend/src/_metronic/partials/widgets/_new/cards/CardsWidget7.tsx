...
const items: Array<{
  ...
  {name: 'Eten', initials: 'E', state: 'warning'},
  {name: 'Eyerusalem',initials: 'E', state: 'warning'},
  {name: 'Hawlet', initials: 'H', state: 'primary'},
  {name: 'Getachew',initials: 'G', state: 'warning'},
  {name: 'Abraham', initials: 'A', state: 'danger'},
  {name: 'Mulugeta',initials: 'M', state: 'warning'},
]
...
const CardsWidget7 = ({className, description, stats, labelColor, textColor}: Props) => (
  <div className={`card card-flush ${className}`}>
    ...
    <div className='card-body d-flex flex-column justify-content-end pe-0'>
      <span className='fs-6 fw-bolder text-gray-800 d-block mb-2'>Heros of the year</span>
